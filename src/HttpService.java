...
public class HttpService {
    /**
     * Método público chamado getJson() com o objetivo de fazer a conexão com a API.
     * @apiNote Usamos o config.properties para que a senha e chave fiquei seguras 
     * 
     * @return Lista completa da API gerada.
     */
